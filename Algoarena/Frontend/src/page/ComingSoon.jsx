...
const ComingSoon = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-gray-100 via-indigo-100 to-purple-100 text-gray-800 flex items-center justify-center px-6 py-10">
