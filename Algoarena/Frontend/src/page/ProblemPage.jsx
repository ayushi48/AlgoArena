...
const ProblemPage = () => {
  ...
  console.log("initialcode9");
  useEffect(() => {
    console.log("initialcode8");
    const fetchProblem = async () => {
      console.log("initialcode0");
      setLoading(true);
      try {
        ...
        console.log("initialcodeeeeeeeeeeeeeeeeee");
  ...
  console.log("initialcodeooooooooooooooooo");
  ...
  const handleSubmitCode = async () => {
    ...
    try {
      ...
      console.log("loooooooooooooooooooooooooooooooooooooooooooooooooo");
      console.log("respncesdwa  " + response);
