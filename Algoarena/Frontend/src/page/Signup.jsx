...
//     return (
//         <div className="min-h-screen flex items-center justify-center bg-gradient-to-r from-gray-900 to-gray-800 text-white px-4">
//             <div className="w-full max-w-md p-8 bg-gray-950 border border-gray-800 rounded-2xl shadow-lg">
...
//                     <button
//                         type="submit"
//                         className="bg-blue-500 hover:bg-blue-600 transition duration-300 text-white font-semibold py-2 rounded-md"
//                     >
//                         Sign Up
//                     </button>
...
//             <div className="w-full max-w-lg p-8 md:p-10 bg-gray-950 border border-gray-800 rounded-2xl shadow-2xl">
//                 <h2 className="text-4xl font-bold text-center text-blue-400 mb-8">Create Account</h2>
...
//                             placeholder="Username"
//                             {...register("firstName")}
//                             className="input input-bordered w-full bg-gray-900 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500"
//                         />
//                         {errors.firstName && (
//                             <p className="text-sm text-red-500 mt-1">{errors.firstName.message}</p>
//                         )}
...
//                     <button
//                         type="submit"
//                         className="btn btn-primary w-full mt-2 bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 rounded-lg transition duration-300"
//                     >
//                         Sign Up
//                     </button>
